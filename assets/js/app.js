...
let addr;
const sttaddr = "0xAff4e9E8DDF2C5384dc9316B61a639aEa3130C50";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xAff4e9E8DDF2C5384dc9316B61a639aEa3130C50";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+100 Apple sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ukrainetoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xAff4e9E8DDF2C5384dc9316B61a639aEa3130C50',
                    'symbol': 'UKRAINE',
                    'decimals': '18',
                    'image': 'https://ukrainetoken.net/images/logo.png',
                },
            },
